                                        ...
                                        <div class="panel-body">
                                            <form method="post" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Run Quarter Allotment</label>
                                                    <button class="btn btn-primary" onClick="apply()">Run</button>
                                                </div>
                                            </form>
                                                        ...
                                                        function apply() {
                                                            jQuery.ajax({
                                                                ...
                                                                success: function (data) {
                                                                    alert("Allotment Ran Successfully " + data);
                                                                },
                                                                error: function () {
                                                                    alert("Error");
                                                                }
